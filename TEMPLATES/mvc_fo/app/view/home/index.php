					...
					<div class="content dark">
						...
						<?php foreach ($data as $onedata) {?>
							...
							<div class="content-inner">
								...
								<h1>CAMEROUN 2017</h1>
								<h5 class="text-muted mb-5"><?= $onedata["pro_title"]?></h5>
								<div class="btn-group">
								<a href="index.php?module=checkout&action=index&fait=ajout&amp;l=<?= $onedata["pro_title"]?>&amp;q=1&amp;p=<?= $onedata["pro_price_euro"]?>" data-toggle="modal" class="btn btn-outline-primary btn-lg">Ajout au panier</a>
