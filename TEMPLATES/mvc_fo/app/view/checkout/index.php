						...
						<div class="shadow bg-white stick-to-content mb-4">
							...
							<table class="table-cart">
								<tr>
									<td class="title">
										...
										<span class="caption text-muted"><?= htmlspecialchars($_SESSION['panier']['libelleProduit'][$i]) ?></span>
									</td>
									<td class="price"><?= htmlspecialchars($_SESSION['panier']['prixProduit'][$i])?></td>
									<td class="actions">
										<a href="index.php?module=checkout&action=index&fait=suppression&l=<?= rawurlencode($_SESSION['panier']['libelleProduit'][$i]); ?>" class="action-icon"><i class="ti ti-close"></i></a>
							...
							<div class="cart-summary">
								<div class="row">
									...
									<div class="col-5"><strong><?= MontantGlobal();?></strong></div>
								</div>
								<div class="row">
								...
								<div class="row text-md">
									...
									<div class="col-5"><strong><?= MontantGlobal()+4;?></strong></div>
