...
<div class="modal fade" id="productModal" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<button type="button" class="modal-btn btn btn-secondary btn-block btn-lg" data-dismiss="modal"><a href="index.php?module=checkout&action=index&fait=ajout&amp;l=<?= $onedata["pro_title"]?>&amp;q=1&amp;p=<?= $onedata["pro_price_euro"]?>" data-toggle="modal" class="btn btn-outline-primary btn-lg">Ajout au panier</a></button>
		</div>
	</div>
</div>
<!-- Modal / Address Edit -->
